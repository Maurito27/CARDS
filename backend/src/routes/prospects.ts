      ...
      try {
        await pool.query(
          ...
          ON CONFLICT (external_id) DO UPDATE SET
            ...
            hipotesis_comercial = EXCLUDED.hipotesis_comercial,
            que_falta_saber = EXCLUDED.que_falta_saber,
            visit_objective = EXCLUDED.visit_objective,
            commercial_evidence = EXCLUDED.commercial_evidence,
            most_valued_feature = EXCLUDED.most_valued_feature,
            main_objection = EXCLUDED.main_objection,
            price_presented = EXCLUDED.price_presented,
            next_action = EXCLUDED.next_action,
            next_action_date = EXCLUDED.next_action_date,
            responsible = EXCLUDED.responsible,
            payment_status = EXCLUDED.payment_status,
            notes = EXCLUDED.notes,
            rating_publico = EXCLUDED.rating_publico,
            cantidad_resenas_publicas = EXCLUDED.cantidad_resenas_publicas,
            rango_precio_publico = EXCLUDED.rango_precio_publico,
            research_completeness = EXCLUDED.research_completeness,
            tipo_fuente = EXCLUDED.tipo_fuente,
            source_ref_auditoria = EXCLUDED.source_ref_auditoria,
            ...
            resultado_ultima_interaccion = EXCLUDED.resultado_ultima_interaccion,
            updated_at = NOW()`,
          [
